...
<div class="kk" style="display:none" name='2'></div>
	<div class="ic-bread">
			<p class="ic-notice fl">在下方选择统计条件，然后点击统计按钮</p>
			<button class="fr tongji" id="but" type="1">统计</button>
			<div class="clear"></div>
		</div>
		<!--main 开始-->
		<div class="ic-main dd">		
			...
			<div class="ic-parts-list" >
				<!--学校-->				
				<div class="ic-group" id="1" style="display:none">
				...
				<div class="ic-group" style="display:none">
					...
					<#list bookList as book>				
						...
						<li condition='0' typeid="${book.id!}" >${book.name!}</li>
					</#list>
					</ul>
				</div>
				<div class="clear"></div>
